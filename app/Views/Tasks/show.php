...
<a class="button is-link is-light" href="<?= site_url('/tasks/edit/' . $task->id) ?>"><?= lang('Tasks.edit') ?></a>
<a class="button is-link is-light" href="<?= site_url('/tasks/delete/' . $task->id) ?>"><?= lang('Tasks.delete') ?></a>
