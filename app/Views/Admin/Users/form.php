...
<div class="field">
       <label class="label" for="password"><? lang('AdminUser.password') ?></label>
...
<div class="field">
       <label class="label" for="password_confirmation"><? lang('AdminUsers.repeat') ?></label>
...
<div class="field">
       <label class="checkbox" for="is_admin">
              <?php if ($user->id == current_user()->id): ?>
                     <input class="checkbox" type="checkbox" checked disabled><? lang('AdminUsers.administrator') ?>

                        <?php else: ?>
                     
                        <input type="hidden" name="is_admin" value="0">

                        <input class="checkbox" type="checkbox" id="is_admin" name="is_admin" value="1"
