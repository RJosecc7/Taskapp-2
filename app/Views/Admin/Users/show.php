...
<a class="button is-link" href="<?= site_url("/admin/users") ?>">&laquo;<?= lang('AdminUsers.back_to_index') ?></a>
...
<a class="button is-link is-light"  href="<?= site_url('/admin/users/edit/' . $user->id) ?>"><?= lang('AdminUsers.edit') ?></a>

<?php if ($user->id != current_user()->id): ?>

    <a class="button is-danger is-light" href="<?= site_url('/admin/users/delete/' . $user->id) ?>"><?= lang('AdminUsers.delete') ?></a>
